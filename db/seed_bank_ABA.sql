-- ============================================================
-- Flow seed for ABA (sourced from MY-01)
...
INSERT INTO flow_steps (flow_template_id, step_number, step_name, action_type, ui_element_key, keymap_type, swipe_key, input_source, pre_delay_ms, post_delay_ms, description) VALUES
  (@handler_1_id, 1, 'swipe_retry', 'SWIPE', NULL, NULL, 'swipe_retry', NULL, 0, 1000, NULL);
...
INSERT INTO flow_steps (flow_template_id, step_number, step_name, action_type, ui_element_key, keymap_type, swipe_key, input_source, pre_delay_ms, post_delay_ms, description) VALUES
  ...
  (@tpl_1, 8, 'enter_account', 'TYPE', NULL, 'aba_account', NULL, 'pay_to_account_no', 0, 500, NULL),
  ...
  (@tpl_1, 12, 'ocr_verify_before_transfer', 'OCR_VERIFY', 'ocr_verify_before_transfer', NULL, NULL, NULL, 1000, 3000, '{"verify_fields":["pay_to_account_no","amount"],"field_rois":{"pay_to_account_no":{"top_percent":39,"bottom_percent":54,"left_percent":14,"right_percent":84},"amount":{"top_percent":25,"bottom_percent":32,"left_percent":14,"right_percent":83},"pay_to_account_name":{"top_percent":47,"bottom_percent":55,"left_percent":32,"right_percent":77}},"roi":{"top_percent":25,"bottom_percent":60,"left_percent":14,"right_percent":83}}'),
  (@tpl_1, 13, 'find_slide', 'FIND_AND_SWIPE', NULL, NULL, 'find_slide', NULL, 0, 500, '{"template":{"enabled":true,"name":"slide_btn"},"ocr":{"enabled":false,"text":"","match":"contains","case_sensitive":false},"combine":"template_only","threshold":0.65,"max_retries":3,"retry_delay_ms":800,"verify_radius_px":30,"disambiguation":"best_score","roi":{"top_percent":40,"bottom_percent":59,"left_percent":25,"right_percent":41},"camera_offsets_mm":[[0,0],[-2,0],[0,-2]],"camera_anchor_mm":[80,60]}'),
  (@tpl_1, 14, 'check_slide_success', 'CHECK_SCREEN', 'check_slide_success', NULL, NULL, NULL, 0, 0, CONCAT('{"reference":"slide_success","handler_flow":"ABA_SLIDE_RETRY__', @handler_1_id, '","threshold":0.8,"max_retries":3,"trigger":"on_mismatch","roi":{"top_percent":17,"bottom_percent":70,"left_percent":15,"right_percent":83}}')),
  (@tpl_1, 15, 'enter_password_2', 'TYPE', NULL, 'aba_pin', NULL, 'pin', 0, 3000, NULL),
