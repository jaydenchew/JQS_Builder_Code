...
('MBB','BKRM','Bank rakyat','BANK KERJASAMA RAKYAT MALAYSIA BERHAD'),
('MBB','BMMB','Bank muamalat','BANK MUALAMAT'),
('MBB','BOFA','Bank of america','BANK OF AMERICA'),
('MBB','BOC','Bank of china malaysia','BANK OF CHINA (MALAYSIA) BERHAD'),
('MBB','AGRO','Agrobank','BANK PERTANIAN MALAYSIA BERHAD (AGROBANK)'),
('MBB','BSN','Bsn','BANK SIMPANAN NASIONAL BERHAD'),
('MBB','BNPPARIBAS','Bnp paribas','BNP PARIBAS MALAYSIA'),
('MBB','BANGKOK','Bangkok bank','Bangkok Bank Berhad'),
...
('MBB','CCBM','China const bk','CHINA CONST BK (M) BERHAD'),
('MBB','CIMB','Cimb','CIMB BANK BERHAD'),
('MBB','CITI','Citibank','CITIBANK BERHAD'),
('MBB','COOPBANK','Co-opbank','Co-opbank Pertama'),
('MBB','DEUTSCHE','Deutsche bank','DEUTSCHE BANK (MSIA) BERHAD'),
...
('MBB','ICBC','Icbc','INDUSTRIAL & COMMERCIAL BANK OF CHINA'),
('MBB','JPMORGAN','Jp morgan','J.P. MORGAN CHASE BANK BERHAD'),
('MBB','KAF','Kaf digital','KAF Digital Bank'),
('MBB','KFH','Kuwait finance','KUWAIT FINANCE HOUSE (MALAYSIA) BHD'),
...
('MBB','RYTBANK','Ryt bank','Ryt Bank'),
('MBB','SETEL','Setel','SETEL'),
('MBB','SCB','Standard chartered','STANDARD CHARTERED BANK'),
('MBB','SMBC','Sumitomo mitsui','SUMITOMO MITSUI BANKING CORPORATION MALAYSIA BHD'),
('MBB','SHOPEPAY','Shopee pay','ShopeePay'),
('MBB','TNG','Touch n go','TOUCH N GO eWALLET'),
('MBB','UOB','Uob','UNITED OVERSEAS BANK BERHAD');
